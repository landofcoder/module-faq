...
class Products extends Extended
{
    ...
    {
        $products = [];
        if(!empty($this->_coreRegistry->registry('current_question')->getData('question_products'))){
            foreach ($this->_coreRegistry->registry('current_question')->getData('question_products') as $product) {
