...
class Add extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Lof\Faq\Model\Question::class);
        ...
        try {
            ...
            $this->messageManager->addSuccess(
                __('Your question has submitted successfully, we will answer that as soon as possible. Thanks you!')
            );
        } catch (\Exception $e) {
